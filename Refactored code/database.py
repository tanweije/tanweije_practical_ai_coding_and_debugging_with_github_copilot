...
class TicketRepository:
    ...
    def seed_defaults(self) -> None:
        with self._lock:
            count_result = self._connection.execute("SELECT count(*) FROM tickets").fetchone()
    ...
    def update(self, ticket_id: int, update: TicketUpdate) -> Ticket:
        ...
        for field, value in changes.items():
            ...
            parameters.append(value.value if hasattr(value, "value") and hasattr(value.value, "value") else value)
